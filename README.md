This is a Pokedex application built with Angular 2 framework using typescript for educational purposes. 

It is based on Restful API https://pokeapi.co/.


The functionality which this application should fulfill is to:
